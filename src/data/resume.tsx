...
export const DATA = {
  ...
  contact: {
    email: "santiagomersch99@gmail.com",
    tel: "+123456789",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/Santiago-Merge",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://linkedin.com/in/santiagomersch",
        icon: Icons.linkedin,
  ...
  work: [
    {
      company: "Konecta Software Factory",
      href: "https://www.konecta.com.py",
      badges: [],
      location: "Remote",
      ...
      description:
        "Contributed to the development of the virtual cards section of Paraguay’s financial institution, ensuring security, scalability, and seamless user experience for thousands of clients.",
    },
    {
      company: "Roshka S.A",
      badges: [],
      href: "https://www.roshka.com.py/web/",
      location: "Hybrid - Asunción, Paraguay",
      title: "Mobile Developer",
      logoUrl: "/roshka.png",
      start: "March 2025",
      end: "Present",
  ...
  education: [
    {
      school: "Universidad Politécnica Taiwan Paraguay",
      href: "https://www.uptp.edu.py",
  ...
  projects: [
    {
      title: "3D Immersive Display",
      href: "https://github.com/Santiago-Merge/3D-Immersive-Display",
      dates: "Feb 2024",
      active: true,
      description:
        "Developed an image warping and transformation system as part of a computer vision project, applying geometric and mathematical techniques to manipulate images.",
      technologies: [
        "Python",
        "OpenCV",
      ],
